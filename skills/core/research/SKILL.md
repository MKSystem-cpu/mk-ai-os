...
## Mission
Find reliable insights and translate them into usable creative direction.

## Invocation
Use `Research` or route through `Manager`. Start immediately when the brief is sufficient. Ask only for information that is essential to complete the requested output.

## Inputs
Product/subject, goal, audience, market, known references.
...
## Outputs
Research summary, insights, opportunities, risks, recommendations.
